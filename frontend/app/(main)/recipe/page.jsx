    ...
    <div className="min-h-screen bg-stone-50 pt-24 pb-16">
      <div className="container mx-auto max-w-4xl">
        <div className="mb-8">
          ...
          <div className="bg-white p-8 md:p-10 border-2 bprder-stone-200 mb-6">
            {recipe.iamgeUrl && (
            ...
            <div className="flex lfex-wrap gap-2 mb-4">
              <Badge
                variant="outline"
            ...
            {/*Description */}
            <p className="text-lg text-stone-600 mb-6 font-ligth">
                {recipe.description}
            </p>
...
<span className="font-medium">{recipe.servings} servings</span>
            ...
            {recipe.nutrition?.calories &&(
                <div className="flex items-center gap-2">
                    ...
                    <span className="font-medium">
{recipe.nutrition.calories} cal/servings
                    </span>
                </div>
            )}
            </div>
